...
# ✅ UNet + Attention + Residual(learnable α)
class BlurUNet(nn.Module):
    def __init__(self, in_channels=3, base_channels=64, attention_module=None):
        ...
        self.out = nn.Sequential(
            ...
            nn.Tanh()  # ✅ Tanh로 출력 정규화
        )

        self.attention = attention_module(base_channels * 4) if attention_module else None
...
if __name__ == "__main__":
    ...
    class_ids = torch.tensor([1, 2, 3, 1])
